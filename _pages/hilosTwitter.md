...
<figure>
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/hilos/spacex.jpg" style="width:70%;/>
</figure>

[2. ¿Cómo se divide una célula?](https://twitter.com/CientificasEr/status/1271123702755864579){:target="_blank"} 

<figure>
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/hilos/celuladiv.JPG" style="width:70%;/>
</figure>
